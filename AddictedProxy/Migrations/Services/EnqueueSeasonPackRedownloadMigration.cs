...
public class EnqueueSeasonPackRedownloadMigration : IMigration
{
    private readonly EntityContext _entityContext;
    private readonly IBackgroundJobClient _backgroundJobClient;
    private readonly ILogger<EnqueueSeasonPackRedownloadMigration> _logger;

    public EnqueueSeasonPackRedownloadMigration(
        EntityContext entityContext,
        IBackgroundJobClient backgroundJobClient,
        ILogger<EnqueueSeasonPackRedownloadMigration> logger)
    {
