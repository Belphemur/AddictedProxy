...
const manualChunk = ["@sentry/nuxt", "@sentry/tracing", "@sentry/browser", "@microsoft/signalr", "lodash-es", "@microsoft/signalr-protocol-msgpack"];
...
export default defineNuxtConfig({
  ...
  modules: ['@nuxtjs/google-fonts', '@pinia/nuxt', '@nuxtjs/device', 'nuxt-lodash', "vuetify-nuxt-module", 'pinia-plugin-persistedstate', '@sentry/nuxt/module'],
  compatibilityDate: '2025-03-08',

  sentry: {
    sourceMapsUploadOptions: {
      org: 'soundswitch',
      project: 'addicted-frontend'
    }
  }
})