...
RUN curl -O http://http.us.debian.org/debian/pool/main/libz/libzstd/libzstd1_1.5.5+dfsg2-2_amd64.deb && dpkg -i libzstd1_1.5.5+dfsg2-2_amd64.deb && rm libzstd1_1.5.5+dfsg2-2_amd64.deb && apt remove curl -y
